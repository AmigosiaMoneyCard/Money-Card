...
export const SEED_SESSIONS: CardSession[] = [
  ...
  },
  {
    ...
    issuedByUserId: 'usr_staff_eros',
    settledByUserId: 'usr_staff_eros',
    refundAmount: 150,
...
export const SEED_PLAN_REQUESTS: PlanChangeRequest[] = [
  ...
  },
  {
    ...
    requestType: 'UPGRADE',
    reason: 'Upgrading branch count and card limit for new semester.',
    status: 'APPROVED',
    adminNotes: 'Direct bank transfer verified. Upgraded limits applied.',
    reviewedBy: 'Super Admin',
    reviewedAt: '2026-02-08T14:30:00.000Z',
  ...
  },
  {
    ...
    requestedPlanName: 'Standard Plan',
    requestType: 'RENEWAL',
    reason: 'Annual contract renewal payment processed via RTGS.',
    status: 'APPROVED',
    adminNotes: 'Payment verified, subscription extended by 1 year.',
    reviewedBy: 'Super Admin',
    reviewedAt: '2026-01-15T11:20:00.000Z',
